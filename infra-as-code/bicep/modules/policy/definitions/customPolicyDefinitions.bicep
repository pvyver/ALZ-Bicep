...
var varCustomPolicySetDefinitionsArray = [
  ...
  {
    name: 'Deploy-Tags'
    libSetDefinition: loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Deploy-Tags.json')
    libSetChildDefinitions: [
      {
        ...
        definitionParameters: varPolicySetDefinitionEsDeployTagsParameters.AddDateCreatedTag.parameters
        definitionGroups: []
      }
    ]
  }
...
var varPolicySetDefinitionEsDeployTagsParameters = loadJsonContent('lib/policy_set_definitions/policy_set_definition_es_Deploy-Tags.parameters.json')
